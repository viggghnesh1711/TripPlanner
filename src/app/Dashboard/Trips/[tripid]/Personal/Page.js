...
import RevenueDashboard from '@/components/Personal';
import Transactions from '@/components/PeronalForm';
...
function Page({ params }) {
  ...
  <>
    ...
    <RevenueDashboard user={userData} tripid={tripid} />
    <Transactions user={userData} tripid={tripid} />
  </>
) : (
  <Loading/>
)}
